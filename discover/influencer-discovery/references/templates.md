...
> defensible score is computed downstream by [fit-scorer](../../../discover/fit-scorer/SKILL.md).
...
1. Review top recommendations with [fit-scorer](../../../discover/fit-scorer/SKILL.md)
