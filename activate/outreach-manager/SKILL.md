...
This skill helps you craft compelling influencer outreach, manage negotiations, and track relationship progress. Good outreach is personal, professional, and persistent without being pushy.
...
Common scenario — negotiate a gap between ask and budget:
...
- **Primary next skill**: [content-reviewer](../../activate/content-reviewer/SKILL.md)
...
When a user requests outreach help:

1. **Gather Outreach Context**
...
- **Primary**: [content-reviewer](../../activate/content-reviewer/SKILL.md) — once a partner is confirmed and creates content, review the draft against the brief before it ships.
