...
| 技能 | 职责 | 锚定 | Canonical event stream / runtime role |
|------|------|------|----------|
| [entity-optimizer](../protocol/entity-optimizer/SKILL.md) | 规范品牌/实体档案（知识图谱、Wikidata、AI 消歧） | SEO/GEO | `memory/events/entities.ndjson` |
...
| [memory-management](../protocol/memory-management/SKILL.md) | HOT/WARM/COLD 记忆生命周期（捕获 · 提升 · 降级 · 归档 · 查询） | 全部学科 | non-canonical `memory/` runtime state |
