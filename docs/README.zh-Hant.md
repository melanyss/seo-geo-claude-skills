...
| 技能 | 職責 | 錨定 | Canonical event stream / runtime role |
|------|------|------|----------|
...
| [memory-management](../protocol/memory-management/SKILL.md) | HOT/WARM/COLD 記憶生命週期（擷取 · 提升 · 降級 · 封存 · 查詢） | 全部學科 | non-canonical `memory/` runtime state |
