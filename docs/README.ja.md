...
| スキル | 役割 | アンカー先 | Canonical event stream / runtime role |
|-------|-----|-------------|-----------------|
...
| [memory-management](../protocol/memory-management/SKILL.md) | HOT/WARM/COLD メモリのライフサイクル（キャプチャ · 昇格 · 降格 · アーカイブ · クエリ） | 全領域 | non-canonical `memory/` runtime state |
