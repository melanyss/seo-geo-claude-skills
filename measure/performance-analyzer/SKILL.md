...
- **Primary next skill**: [roi-calculator](../../measure/roi-calculator/SKILL.md) — turn measured performance into dollar-level return.
...
- Sibling skills: [roi-calculator](../../measure/roi-calculator/SKILL.md), [report-generator](../../measure/report-generator/SKILL.md), [fit-scorer](../../discover/fit-scorer/SKILL.md), [campaign-planner](../../plan/campaign-planner/SKILL.md).

## Next Best Skill

**Primary**: [roi-calculator](../../measure/roi-calculator/SKILL.md) — convert measured performance into dollar-level ROI, cost-per-result, and payback math.

**Alternates** (same Track family):

- [report-generator](../../measure/report-generator/SKILL.md) — package the analysis into a formal stakeholder report.
