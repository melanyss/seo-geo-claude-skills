...
**Diagnosis**: Low CITE + unknown CORE-EEAT → Run `/aaron-marketing:audit` on top 5 landing pages to determine whether to prioritize content quality or domain authority first.
...
- For tracking progress: run `/aaron-marketing:track --report` with CITE score trends quarterly
```
